...
export default class Command extends BaseCommand {
    ...
    run = async (M: ISimplifiedMessage): Promise<void> => {
        let text = ''
        text += '*👾 hitman47 👾*\n'
        text += '*🔗 README* : https://github.com/Dkhitman3/hitman47#readme\n'
        text += '*🔗 FEATURES* : https://github.com/PrajjwalDatir/Kaoi/blob/main/Features.md\n'
        text += '*🔗 CONTRIBUTERS* : https://github.com/Dkhitman3/hitman47/graphs/contributors\n'
        ...
        text += `*🔗 Deploy Video Guide 🔗 : https://www.youtube.com/watch?v=tsCCmxeklHw*
            Follow this video Guide but instead of using the *WhatsApp Botto Xre* Link, use the *hitman47 Github Link* given above.\n`
        ...
        text += '\n_Thank You for using Kaoi. Help others setup hitman47 by contribution to Kaoi Guides_'
